...
// EXTENSIVELY EXPANDED CULTURAL EDUCATION translation system with complete Pontanus text
...
Ante 500 annos hoc renovamen incepit. In Dania per observationes astronomicas Tychonis Brahe, qui fundamenta Kepleri operis et scientiarum naturalium modernarum posuit. Tychonis adiutor Macrobii epistulam recordatus primam editionem completam et annotatam composuit. Hic liber in manus meas venit et mihi idea venit hanc parvam applicationem de hac historia facere.... Gaude!`,
    ...
    pontanus_historical_details: `Textus sequitur 117 paginis notarum Pontani plenis. Ultimae 16 paginae brevibus notis iuvenis Johannis Meursii replentur, qui anno 1597 XVIII annos natus erat et adhuc studebat. Meursius puer prodigiosus erat, qui aetate XII annorum matriculatus est.`
  }
};
...
// Main CULTURAL EDUCATION application (CORRECTED CLASSIC STYLE)
export default function MacrobiusCulturalApp() {
  ...
  // Remove mouse position - stars move independently
  ...
  // Stars move independently - no mouse tracking needed
  ...
  // CORRECTED: Section change with astrolabe rotation only
  const handleSectionChange = (section: string) => {
    setActiveSection(section);
    // Rotate astrolabe on section change
  ...
  return (
    <>
      ...
      {/* CORRECTED: Azure Evening Gradient Background */}
      <div className="min-h-screen relative overflow-x-hidden" style={{
        background: 'linear-gradient(135deg, #007BC7 0%, #005A9C 50%, #004080 100%)'
      }}>
        {/* Enhanced Animated Starfield - Moving Right to Left */}
        <div className="fixed inset-0 z-0">
          ...
          {/* All stars moving from right to left continuously */}
          {[...Array(50)].map((_, i) => (
            <div
              key={`moving-${i}`}
        ...
        {/* FLOATING MACROBIUS CIRCLE - Above Hero Section */}
        {activeSection === 'hero' && (
          <div className="fixed inset-0 z-20 pointer-events-none">
            <motion.div 
              ...
              style={{
                marginTop: '-200px' // Position above the hero content
              }}
            >
        ...
        {/* Navigation Sidebar (SINGLE ICONS) */}
            ...
            <section className="min-h-screen flex items-center justify-center px-4">
              <div className="text-center max-w-7xl mx-auto">
                ...
                <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/30 mb-8">
                  ...
                  {/* Simple static icon - Macrobius image now floats above */}
        ...
        {/* ENHANCED: Pontanus Modal with IMAGE and complete text */}
        <AnimatePresence>
          {showPontanusModal && (
            <motion.div
              className="fixed inset-0 z-50 flex items-center justify-center p-4"
            ...
            >
              ...
              >
                ...
                <div className="space-y-8">
                  ...
                  {/* ADDED: Pontanus Image */}
                  <div className="flex justify-center mb-6">
                    <div className="relative">
                      <img 
                        src="/TychoAssistent.jpg" 
                        alt="Johannes Isaac Pontanus - Tycho Brahes Assistent"
                        className="w-48 h-64 object-cover rounded-xl border-4 border-orange-400 shadow-xl"
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent rounded-xl"></div>
                      <div className="absolute bottom-4 left-4 right-4">
                        <p className="text-white text-sm font-semibold">Pontanus als Tycho Brahes Assistent</p>
                      </div>
                    </div>
                  </div>
                  ...
                  {/* NEW: Historical Details from scans */}
