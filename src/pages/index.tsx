...
export default function MacrobiusCulturalApp() {
  ...
  return (
    <>
      ...
      {/* CORRECTED: Much Darker Evening Sky Gradient Background - "Sky very late evening" look */}
                  ...
                  <div className="flex justify-center mb-6">
                    <div className="relative">
                      ...
                      <div className="absolute bottom-4 left-4 right-4">
                        <p className="text-white text-sm font-semibold">Johannes Isaac Pontanus (1571-1639)</p>
                      </div>
                    </div>
                  </div>
