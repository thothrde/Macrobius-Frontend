...
const QuizSection: React.FC<QuizSectionProps> = ({ 
  ...
  const tLocal = translations[language.code as keyof typeof translations] || translations.en;
              ...
              return (
                ...
                >
                  <CardContent className="p-4 text-center">
                    ...
                    <h3 className="font-semibold text-sm mb-1">{tLocal.categories[key as keyof typeof tLocal.categories]}</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-3">
                ...
                >
                  ...
                  {showHint ? 'Hide Hint' : tLocal.actions.showHint}
                </Button>
  ...
  useEffect(() => {
    const checkBackendStatus = async () => {
      try {
        // Simulated backend health check
          ...
          <Tabs value={quizMode} onValueChange={(value) => setQuizMode(value as any)}>
            <TabsList className="grid w-full grid-cols-4 mb-8 bg-white/10 backdrop-blur-sm">
              ...
              <TabsTrigger value="results" className="text-white" disabled={!currentQuizSession}>
                ...
                {tLocal.modes.results}
              </TabsTrigger>
              <TabsTrigger value="analytics" className="text-white">
                <BarChart3 className="w-4 h-4 mr-2" />
                {tLocal.modes.analytics}
              </TabsTrigger>
            </TabsList>
