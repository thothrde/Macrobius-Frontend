  ...
  return (
    <section className={`py-24 bg-gradient-to-br from-purple-50 via-pink-50 to-indigo-50 ${className}`}>
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        {/* FIXED: Plotinus Quote positioned BELOW the chat window */}
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <div className="max-w-2xl mx-auto p-6 bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 rounded-xl">
            ...
            <blockquote className="text-lg text-amber-800 italic font-medium leading-relaxed">
